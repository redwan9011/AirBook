...
const Footer = () => {
    return (
        <div className="pb-10 bg-blue-600">
            <footer className="footer py-10  text-white mt-10 max-w-6xl mx-auto">
  <nav>
...
<footer className="footer justify-between items-center p-4 text-white max-w-6xl mx-auto" >
  <aside className="items-center grid-flow-col">
<img src="https://i.ibb.co/x6BxnCG/Capture.png" alt="" />
